...
```{r, echo=TRUE, eval=TRUE}
t30_act_rate_seiqhrf_sim_df <- simulate(act.rate.i = c(rep(10,30), rep(5, 335)))

t30_inf_prob_seiqhrf_sim_df <- simulate(inf.prob.i = c(rep(0.05,30), rep(0.025, 335)))

t30_both_seiqhrf_sim_df <- simulate(inf.prob.i = c(rep(0.05,30), rep(0.025, 335)),
                                    act.rate.i = c(rep(10,30), rep(5, 335)))

t15_act_rate_seiqhrf_sim_df <- simulate(act.rate.i = c(rep(10,15), rep(5, 350)))

t15_inf_prob_seiqhrf_sim_df <- simulate(inf.prob.i = c(rep(0.05,15), rep(0.025, 350)))

t15_both_seiqhrf_sim_df <- simulate(inf.prob.i = c(rep(0.05,15), rep(0.025, 350)), 
