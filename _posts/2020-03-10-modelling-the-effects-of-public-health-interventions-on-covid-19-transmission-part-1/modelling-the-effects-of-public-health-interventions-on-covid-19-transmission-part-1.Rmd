...
* not touching your face, moth, nose or eyes, to avoid transferring virus to your nasopharynx and thence to your respiratory tract
* frequent cleaning or disinfection of [_fomites_](https://en.wikipedia.org/wiki/Fomite)

We can simulate such hygiene measures in our model by adjusting the probability of infection (at each occasion of exposure). In later posts we will make these behavioural adjustments more nuanced, but for now, we will assume that they apply, on average, to everyone in the population.
...
sims_incidence_rates %>%
  ...
  labs(x="Days since start of epidemic", y="Prevalent (current number of active) cases",
       title="Modelling of prevalence of COVID-19 cases",
       subtitle=paste("with varying levels of social mixing (exposures per day)",
